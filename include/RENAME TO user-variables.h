...
// This will be the prefix for the MQTT topic and sensor names
// eg if you set it to "plant1" then the topic will be "plant1/temperature"
// and the sensor name will be "sensors.plant1_temperature"
String plant_name = "my_plant";

// Device configuration and name setting
// This will appear as a device in Home Assistant MQTT Autodiscovery
// This can be changed to whatever you want, but it is recommended to keep it the same as the plant name
const String device_name = "My Plant Sensor";
