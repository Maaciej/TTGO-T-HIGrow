...
float readBattery(uint16_t voltx) {
  ...
  float battery_voltage =
      (bat_volt_high - bat_volt_low) / (bat_reading_high - bat_reading_low) * volt + bat_volt_high -
          bat_reading_high * (bat_volt_high - bat_volt_low) / (bat_reading_high - bat_reading_low); // true volts
  config.battery_voltage = battery_voltage;
